<template>
  ...
  >
    <!-- ===== TIER 1: ICP MAINNET ===== -->
    <g id="d-icp-mainnet">
      <rect x="0.5" y="0.5" width="719" height="378" rx="16"
        fill="#111820" stroke="#2a2218" stroke-width="1" />
      <text x="360" y="30" text-anchor="middle"
        fill="#e8a317" font-size="13" font-weight="700" letter-spacing="3px"
      ...
      <!-- Registry Canister -->
      <g>
        <rect x="140" y="48" width="192" height="130" rx="8"
          fill="#111820" stroke="#1e2a3a" stroke-width="1" />
        <text x="236" y="72" text-anchor="middle"
          fill="#ffffff" font-size="12" font-weight="600">REGISTRY</text>
        <text x="236" y="87" text-anchor="middle"
          fill="#665e53" font-size="10">CANISTER</text>
      ...
      <!-- Frontend Canister -->
      <g>
        <rect x="388" y="48" width="216" height="130" rx="8"
          fill="#111820" stroke="#1e2a3a" stroke-width="1" />
        <text x="496" y="72" text-anchor="middle"
          fill="#ffffff" font-size="12" font-weight="600">FRONTEND</text>
        <text x="496" y="87" text-anchor="middle"
          fill="#665e53" font-size="10">CANISTER</text>
      ...
      <g>
        <line x1="388" y1="113" x2="340" y2="113"
          stroke="#e8a317" stroke-width="1" stroke-dasharray="4,3" opacity="0.4" />
      ...
      <g>
        <path d="M 236,178 L 236,196 L 312,196 L 312,208"
          fill="none" stroke="#e8a317" stroke-width="1.5" />
        <polygon points="312,218 306,208 318,208" fill="#e8a317" />
        <text x="274" y="191" fill="#665e53" font-size="10" font-style="italic" text-anchor="middle">spawns</text>
      </g>

      <!-- Frontend → Engram (Owner manages) — L-shaped -->
      <g>
        <path d="M 496,178 L 496,196 L 408,196 L 408,208"
          fill="none" stroke="#e8a317" stroke-width="1" stroke-dasharray="4,3" opacity="0.5" />
        <polygon points="408,218 402,208 414,208" fill="#e8a317" opacity="0.5" />
        <text x="452" y="191" fill="#665e53" font-size="9" font-style="italic" text-anchor="middle">Owner manages</text>
      </g>

      <!-- Engram Canister -->
      <g>
        <rect x="264" y="218" width="192" height="146" rx="8"
          fill="#111820" stroke="#e8a317" stroke-width="1" opacity="0.8" />
        <text x="360" y="238" text-anchor="middle"
          fill="#ffffff" font-size="12" font-weight="600">ENGRAM</text>
        <text x="360" y="253" text-anchor="middle"
          fill="#665e53" font-size="10">CANISTER</text>
    ...
    <g>
      ...
      <text x="386" y="400" fill="#e8a317" font-size="11" font-weight="600"
        font-family="'IBM Plex Mono', ui-monospace, monospace">
        @engramx/client (npm)
      </text>
    ...
    <!-- ===== TIER 2: AGENT HOST ===== -->
    <g>
      <rect x="0.5" y="432" width="719" height="127" rx="16"
        fill="#111820" stroke="#2a2218" stroke-width="1" />
      <text x="360" y="458" text-anchor="middle"
        fill="#ffffff" font-size="13" font-weight="700">
        AGENT HOST
        <tspan fill="#665e53" font-size="11" font-weight="400" font-style="italic"> (disposable, runs as Operator)</tspan>
      </text>
      ...
      <text x="210" y="504" fill="#9a9083" font-size="11">Operator session key (Ed25519, revocable by Owner/Guardian)</text>
      ...
      <text x="210" y="540" fill="#9a9083" font-size="11">Channel adapters (Telegram, WhatsApp, etc.)</text>
    </g>
  </svg>
  ...
  >
    ...
    <rect x="0.5" y="0.5" width="299" height="410" rx="12"
      fill="#111820" stroke="#2a2218" stroke-width="1" />
    <text x="150" y="24" text-anchor="middle"
      fill="#e8a317" font-size="11" font-weight="700" letter-spacing="2px"
      font-family="'IBM Plex Mono', ui-monospace, monospace">
      ICP MAINNET
    </text>
    ...
    <!-- Frontend Canister -->
    <g>
      <rect x="16" y="36" width="268" height="82" rx="6"
        fill="#111820" stroke="#1e2a3a" stroke-width="1" />
      <text x="150" y="54" text-anchor="middle"
        fill="#ffffff" font-size="11" font-weight="600">FRONTEND</text>
      <text x="150" y="66" text-anchor="middle"
        fill="#665e53" font-size="9">CANISTER</text>
    ...
    <g>
      <line x1="150" y1="118" x2="150" y2="136" stroke="#e8a317" stroke-width="1" stroke-dasharray="3,2" opacity="0.4" />
    ...
    <g opacity="0.5">
      <path d="M 284,100 L 294,100 L 294,258 L 284,258"
        fill="none" stroke="#e8a317" stroke-width="0.75" stroke-dasharray="3,2" />
      <polygon points="284,258 292,254 292,262" fill="#e8a317" />
      <text x="294" y="180" fill="#665e53" font-size="7"
        transform="rotate(90 294 180)" text-anchor="middle">Owner manages</text>
    </g>

    <!-- Registry Canister -->
    <g>
      <rect x="16" y="142" width="268" height="82" rx="6"
        fill="#111820" stroke="#1e2a3a" stroke-width="1" />
      <text x="150" y="160" text-anchor="middle"
        fill="#ffffff" font-size="11" font-weight="600">REGISTRY</text>
    ...
    <!-- Engram Canister -->
    <g>
      <rect x="16" y="250" width="268" height="106" rx="6"
        fill="#111820" stroke="#e8a317" stroke-width="1" opacity="0.8" />
      <text x="150" y="268" text-anchor="middle"
        fill="#ffffff" font-size="11" font-weight="600">ENGRAM</text>
    ...
    <!-- "..." more engrams -->
    <text x="240" y="380" text-anchor="middle" fill="#665e53" font-size="14" font-weight="300">...</text>
    ...
    <g>
      ...
      <text x="166" y="430" fill="#e8a317" font-size="9" font-weight="600"
        font-family="'IBM Plex Mono', ui-monospace, monospace">
        @engramx/client
      </text>
    ...
    <!-- ===== AGENT HOST ===== -->
    <rect x="0.5" y="458" width="299" height="121" rx="12"
      fill="#111820" stroke="#2a2218" stroke-width="1" />
    <text x="150" y="478" text-anchor="middle"
      fill="#ffffff" font-size="11" font-weight="700">
      AGENT HOST
    </text>
    <text x="150" y="492" text-anchor="middle"
      fill="#665e53" font-size="8" font-style="italic">
    ...
    <text x="34" y="550" fill="#9a9083" font-size="9">Channel adapters (Telegram, WhatsApp, etc.)</text>
  </svg>
</template>
