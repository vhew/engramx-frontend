...
<template>
  <div class="relative group">
    <pre class="border border-gray-700 rounded-md p-4 overflow-x-auto text-left" style="background:#080c12"><code class="text-sm font-mono" style="color:#9a9083">{{ code }}</code></pre>
    <button
