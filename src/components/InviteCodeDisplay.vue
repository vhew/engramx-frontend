...
<template>
  <div class="bg-gray-800/50 border border-gray-700 rounded-lg p-4">
    <div class="flex items-center justify-between mb-2">
      <span class="text-3xl font-mono font-bold text-engram-400 tracking-widest">{{ inviteCode }}</span>
    ...
    <code class="text-gray-300 text-sm block bg-gray-900 rounded-sm px-3 py-2 break-all">{{ pairCommand }}</code>
