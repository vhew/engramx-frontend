  ...
  <div class="max-w-3xl mx-auto px-4 py-8">
    ...
    <div v-if="!actor" class="card text-center py-12">
      ...
      <p class="text-gray-500 text-sm mt-2">
        Ask an engram owner to send you a guardian invite link.
      </p>
    </div>
      ...
      <div v-if="record && 'Pending' in record.status" class="card mb-6">
        <div class="flex items-center gap-3">
          ...
          <span class="text-gray-400 text-sm"
            >The engram owner needs to approve your guardianship before you can perform
            actions.</span
          >
        </div>
      </div>
        ...
        <div v-else>
          <div class="card mb-6">
            ...
            <EmergencyActions
              ...
              :permissions="
                record?.permissions || {
                  canRevokeOperators: false,
                  canFreezePayments: false,
                  canPauseWrites: false,
                }
              "
