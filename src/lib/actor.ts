...
export const REGISTRY_CANISTER_ID = import.meta.env.VITE_REGISTRY_CANISTER_ID || 'bkyz2-fmaaa-aaaaa-qaaaq-cai';
...
export const registryIdlFactory = ({ IDL }: { IDL: any }) => {
  ...
  return IDL.Service({
    createEngram: IDL.Func([], [IDL.Variant({ Ok: IDL.Record({ canisterId: IDL.Principal }), Err: IDL.Text })], []),
    topUpEngram: IDL.Func([], [IDL.Variant({ Ok: IDL.Record({ newCyclesBalance: IDL.Nat }), Err: IDL.Text })], []),
    getMyEngram: IDL.Func([], [IDL.Opt(EngramRecord)], ['query']),
    getEngramByCanisterId: IDL.Func([IDL.Principal], [IDL.Opt(EngramRecord)], ['query']),
    listEngrams: IDL.Func([IDL.Nat, IDL.Nat], [IDL.Record({ engrams: IDL.Vec(EngramRecord), total: IDL.Nat })], ['query']),
    status: IDL.Func([], [IDL.Record({
      totalEngrams: IDL.Nat,
      activeEngrams: IDL.Nat,
      registryVersion: IDL.Text,
      engramWasmHash: IDL.Text,
      treasurySummary: IDL.Record({ totalIcpReceivedE8s: IDL.Nat, totalCyclesAllocated: IDL.Nat }),
      cycleReserve: IDL.Nat,
    })], ['query']),
    getEngramWasmHash: IDL.Func([], [IDL.Text], ['query']),
    // Treasury & top-up
    getMyDepositAddress: IDL.Func([], [IDL.Record({ owner: IDL.Principal, subaccount: IDL.Opt(IDL.Vec(IDL.Nat8)) })], ['query']),
    topUpEngramWithIcp: IDL.Func([], [IDL.Variant({ Ok: IDL.Record({ cyclesDeposited: IDL.Nat, icpChargedE8s: IDL.Nat }), Err: IDL.Text })], []),
    getTreasury: IDL.Func([], [TreasuryRecord], ['query']),
    getMyEngramAccounting: IDL.Func([], [IDL.Opt(EngramAccountingRecord)], ['query']),
    // Changelog
    addChangelogEntry: IDL.Func([IDL.Text, IDL.Text], [IDL.Variant({ Ok: IDL.Null, Err: IDL.Text })], []),
    getChangelog: IDL.Func([], [IDL.Vec(IDL.Record({
      version: IDL.Text, wasmHash: IDL.Text, releaseNotes: IDL.Text, timestamp: IDL.Int,
    }))], ['query']),
    // Sovereignty
    ...
    getSovereigntyStatus: IDL.Func([], [IDL.Variant({ Managed: IDL.Null, Sovereign: IDL.Null, Unknown: IDL.Text })], []),
    // Upgrades
    ...
    topUpEngramWithCkusdc: IDL.Func([], [IDL.Variant({ Ok: IDL.Record({ cyclesDeposited: IDL.Nat, stablecoinChargedE6s: IDL.Nat, token: IDL.Text }), Err: IDL.Text })], []),
    topUpEngramWithStablecoin: IDL.Func([IDL.Text], [IDL.Variant({ Ok: IDL.Record({ cyclesDeposited: IDL.Nat, stablecoinChargedE6s: IDL.Nat, token: IDL.Text }), Err: IDL.Text })], []),
    // Depeg protection
    setMaxDepegBps: IDL.Func([IDL.Nat], [IDL.Variant({ Ok: IDL.Null, Err: IDL.Text })], []),
    getMaxDepegBps: IDL.Func([], [IDL.Nat], ['query']),
    // Exchange rate
    getIcpUsdRate: IDL.Func([], [IDL.Record({ rate: IDL.Nat64, decimals: IDL.Nat32, updatedAt: IDL.Int })], ['query']),
    // Metrics
    publicMetrics: IDL.Func([], [IDL.Record({
      totalEngrams: IDL.Nat,
      activeEngrams: IDL.Nat,
    ...
    privateMetrics: IDL.Func([], [IDL.Variant({
      Ok: IDL.Record({
        totalEngrams: IDL.Nat,
        activeEngrams: IDL.Nat,
        uniqueOwners: IDL.Nat,
    ...
    removeMetricsViewer: IDL.Func([IDL.Principal], [IDL.Variant({ Ok: IDL.Null, Err: IDL.Text })], []),
    listMetricsViewers: IDL.Func([], [IDL.Vec(IDL.Principal)], ['query']),
    // Treasury ledger & snapshots
    getSnapshots: IDL.Func([IDL.Int, IDL.Int], [IDL.Variant({
      Ok: IDL.Vec(IDL.Record({
        timestamp: IDL.Int, totalCyclesAllocated: IDL.Nat, totalIcpReceivedE8s: IDL.Nat,
        platformFeeE8s: IDL.Nat, operationalFundE8s: IDL.Nat, cycleReserve: IDL.Nat,
        totalEngrams: IDL.Nat, activeEngrams: IDL.Nat, uniqueOwners: IDL.Nat,
        sovereignEngrams: IDL.Nat, totalTopUpEvents: IDL.Nat,
        periodCycles: IDL.Nat, periodIcpE8s: IDL.Nat, periodFeeE8s: IDL.Nat, periodEvents: IDL.Nat,
      })),
      Err: IDL.Text,
    })], ['query']),
    getTreasuryLedger: IDL.Func([IDL.Int, IDL.Nat], [IDL.Variant({
      Ok: IDL.Vec(IDL.Record({
        id: IDL.Nat, timestamp: IDL.Int,
        kind: IDL.Variant({ EngramCreated: IDL.Null, TopUpCycles: IDL.Null, TopUpIcp: IDL.Null, TopUpCkusdc: IDL.Null, TopUpCkusdt: IDL.Null }),
        engram: IDL.Principal, gross: IDL.Nat, cycles: IDL.Nat, fee: IDL.Nat,
      })),
      Err: IDL.Text,
    })], ['query']),
...
export const engramIdlFactory = ({ IDL }: { IDL: any }) => {
  ...
  const OperatorPermissions = IDL.Record({
    canReadMemory: IDL.Bool, canAppendMemory: IDL.Bool,
    canReadSessions: IDL.Bool, canAppendSessions: IDL.Bool,
    canSearchMemory: IDL.Bool, canReadConfig: IDL.Bool,
    canReadWallet: IDL.Bool, canTransferFunds: IDL.Bool,
    dailySpendingLimitE8s: IDL.Nat, allowlistedAddresses: IDL.Vec(Account),
    callsPerMinute: IDL.Nat, maxSessionTTLNanos: IDL.Int,
  });
  const OperatorRecord = IDL.Record({
    principal: IDL.Principal, name: IDL.Text, registeredAt: IDL.Int,
    lastSeen: IDL.Int, permissions: OperatorPermissions,
    status: IDL.Variant({ Active: IDL.Null, Revoked: IDL.Null, Expired: IDL.Null }),
    publicKeyHash: IDL.Opt(IDL.Text), keyRotatedAt: IDL.Int, keyRotationCount: IDL.Nat,
  });
  const GuardianPermissions = IDL.Record({
    canRevokeOperators: IDL.Bool, canFreezePayments: IDL.Bool, canPauseWrites: IDL.Bool,
  });
  const GuardianRecord = IDL.Record({
    principal: IDL.Principal, name: IDL.Text, addedAt: IDL.Int,
    permissions: GuardianPermissions,
    status: IDL.Variant({ Pending: IDL.Null, Active: IDL.Null }),
  });
  const AgentIdentity = IDL.Record({
    ethAddress: IDL.Opt(IDL.Text), derivationPath: IDL.Opt(IDL.Vec(IDL.Nat8)),
    createdAt: IDL.Int,
  });
  const PaymentAuthorization = IDL.Record({
    from: IDL.Text, to: IDL.Text, value: IDL.Nat,
    validAfter: IDL.Int, validBefore: IDL.Int, nonce: IDL.Text, signature: IDL.Text,
  });
  const VerificationLevel = IDL.Variant({ Orb: IDL.Null, Device: IDL.Null, Document: IDL.Null });
  const WorldIdProof = IDL.Record({
    nullifierHash: IDL.Text, merkleRoot: IDL.Text, proof: IDL.Text,
    verificationLevel: VerificationLevel, verifiedAt: IDL.Int,
  });
  const MemoryFile = IDL.Record({
    path: IDL.Text, content: IDL.Text, version: IDL.Nat,
    lastModifiedBy: IDL.Principal, lastModifiedAt: IDL.Int, isIdentityFile: IDL.Bool,
  });
  const MemoryVersion = IDL.Record({
    version: IDL.Nat, modifiedBy: IDL.Principal, modifiedAt: IDL.Int,
  ...
  const SessionMessage = IDL.Record({
    ...
    content: IDL.Text, timestamp: IDL.Int,
  });
  const SessionInfo = IDL.Record({ sessionKey: IDL.Text, messageCount: IDL.Nat, firstMessage: IDL.Int, lastMessage: IDL.Int });
  const SearchResult = IDL.Record({ path: IDL.Text, snippet: IDL.Text, score: IDL.Float64, startLine: IDL.Nat });
  const AuditEntry = IDL.Record({
    id: IDL.Nat, timestamp: IDL.Int, caller: IDL.Principal,
    callerRole: IDL.Variant({ Owner: IDL.Null, Operator: IDL.Null, Guardian: IDL.Null }),
    operation: IDL.Text, details: IDL.Text, success: IDL.Bool,
  });
  const AgentConfig = IDL.Record({
    name: IDL.Text, model: IDL.Text, systemPrompt: IDL.Opt(IDL.Text),
    skills: IDL.Vec(IDL.Tuple(IDL.Text, IDL.Text)),
    preferences: IDL.Vec(IDL.Tuple(IDL.Text, IDL.Text)),
  });
  const BackupType = IDL.Variant({ FullSnapshot: IDL.Null, PartialSnapshot: IDL.Null, IncrementalDiff: IDL.Null });
  const BackupStatus = IDL.Variant({ Uploading: IDL.Null, Finalized: IDL.Null, Failed: IDL.Null });
  const BackupMetadata = IDL.Record({
    backupId: IDL.Text, dbType: IDL.Text, backupType: BackupType,
    parentBackupId: IDL.Opt(IDL.Text), totalSize: IDL.Nat, chunkCount: IDL.Nat,
    sha256: IDL.Text, createdAt: IDL.Int, createdBy: IDL.Principal,
    backupLabel: IDL.Opt(IDL.Text), status: BackupStatus,
  });
  ...
  return IDL.Service({
    ...
    createGuardianInvite: IDL.Func([IDL.Text, GuardianPermissions], [IDL.Variant({ Ok: IDL.Text, Err: IDL.Text })], []),
    ...
    checkGuardianStatus: IDL.Func([], [IDL.Variant({ Ok: GuardianRecord, Err: IDL.Text })], ['query']),
    listOperatorsForGuardian: IDL.Func([], [IDL.Vec(IDL.Record({
      principal: IDL.Principal, name: IDL.Text,
      status: IDL.Variant({ Active: IDL.Null, Revoked: IDL.Null, Expired: IDL.Null }),
    }))], ['query']),
    ...
    // Owner-only
    setIdentityFile: IDL.Func([IDL.Text, IDL.Text], [IDL.Variant({ Ok: IDL.Nat, Err: IDL.Text })], []),
    ...
    setTransferAllowlist: IDL.Func([IDL.Vec(Account)], [IDL.Variant({ Ok: IDL.Null, Err: IDL.Text })], []),
    setDailySpendingLimit: IDL.Func([IDL.Principal, IDL.Nat], [IDL.Variant({ Ok: IDL.Null, Err: IDL.Text })], []),
    ...
    setTopUpLimits: IDL.Func([IDL.Nat, IDL.Nat], [IDL.Variant({ Ok: IDL.Null, Err: IDL.Text })], []),
    getTopUpLimits: IDL.Func([], [IDL.Record({ maxCkusdcE6s: IDL.Nat, cooldownSeconds: IDL.Nat })], ['query']),
    // Memory
    ...
    // Sessions
    readSession: IDL.Func([IDL.Text, IDL.Nat, IDL.Nat], [IDL.Variant({ Ok: IDL.Vec(SessionMessage), Err: IDL.Text })], ['query']),
    appendSession: IDL.Func([IDL.Text, IDL.Vec(SessionMessage)], [IDL.Variant({ Ok: IDL.Nat, Err: IDL.Text })], []),
    ...
    walletBalances: IDL.Func([], [IDL.Variant({ Ok: IDL.Record({ cycles: IDL.Nat, icpE8s: IDL.Nat, ckusdcE6s: IDL.Nat, ckusdtE6s: IDL.Nat }), Err: IDL.Text })], []),
    ...
    signWithAgentKey: IDL.Func([IDL.Vec(IDL.Nat8)], [IDL.Variant({ Ok: IDL.Vec(IDL.Nat8), Err: IDL.Text })], []),
    // x402 Payment
    createPaymentAuthorization: IDL.Func([IDL.Text, IDL.Nat], [IDL.Variant({ Ok: PaymentAuthorization, Err: IDL.Text })], []),
    // World ID
    ...
    // Status
    status: IDL.Func([], [IDL.Record({
      owner: IDL.Opt(IDL.Principal), memoryFileCount: IDL.Nat, sessionCount: IDL.Nat,
      auditLogSize: IDL.Nat, operatorCount: IDL.Nat, cyclesBalance: IDL.Nat, version: IDL.Text,
      guardianCount: IDL.Nat, paymentsFrozen: IDL.Bool, writesPaused: IDL.Bool,
      backupCount: IDL.Nat, totalBackupSize: IDL.Nat,
      totalMemoryWrites: IDL.Nat, totalSessionAppends: IDL.Nat,
    })], ['query']),
    metrics: IDL.Func([], [IDL.Record({
      totalMemoryReads: IDL.Nat, totalMemoryWrites: IDL.Nat,
      totalSessionAppends: IDL.Nat, totalSearches: IDL.Nat,
    })], ['query']),
...
export const icManagementIdlFactory = ({ IDL }: { IDL: any }) => {
  ...
  return IDL.Service({
    canister_status: IDL.Func([IDL.Record({ canister_id: IDL.Principal })], [CanisterStatusResult], []),
...
const ICP_LEDGER_CANISTER_ID = import.meta.env.VITE_ICP_LEDGER_CANISTER_ID || (import.meta.env.DEV ? 'ryjl3-tyaaa-aaaaa-aaaba-cai' : 'ryjl3-tyaaa-aaaaa-aaaba-cai');
...
const CKUSDC_LEDGER_CANISTER_ID = import.meta.env.VITE_CKUSDC_LEDGER_CANISTER_ID || 'xevnm-gaaaa-aaaar-qafnq-cai';
...
const CKUSDT_LEDGER_CANISTER_ID = import.meta.env.VITE_CKUSDT_LEDGER_CANISTER_ID || 'cngnf-vqaaa-aaaar-qag4q-cai';
...
const ICP_INDEX_CANISTER_ID = import.meta.env.VITE_ICP_INDEX_CANISTER_ID || 'qhbym-qaaaa-aaaaa-aaafq-cai';

export const indexIdlFactory = ({ IDL }: { IDL: any }) => {
  const Account = IDL.Record({ owner: IDL.Principal, subaccount: IDL.Opt(IDL.Vec(IDL.Nat8)) });
  const Transaction = IDL.Record({
    kind: IDL.Text,
    mint: IDL.Opt(IDL.Record({ amount: IDL.Nat, to: Account, memo: IDL.Opt(IDL.Vec(IDL.Nat8)), created_at_time: IDL.Opt(IDL.Nat64) })),
    burn: IDL.Opt(IDL.Record({ amount: IDL.Nat, from: Account, memo: IDL.Opt(IDL.Vec(IDL.Nat8)), created_at_time: IDL.Opt(IDL.Nat64), spender: IDL.Opt(Account) })),
    transfer: IDL.Opt(IDL.Record({
      amount: IDL.Nat, from: Account, to: Account,
      memo: IDL.Opt(IDL.Vec(IDL.Nat8)), created_at_time: IDL.Opt(IDL.Nat64),
      fee: IDL.Opt(IDL.Nat), spender: IDL.Opt(Account),
    })),
    approve: IDL.Opt(IDL.Record({
      amount: IDL.Nat, from: Account, spender: IDL.Opt(Account),
      memo: IDL.Opt(IDL.Vec(IDL.Nat8)), created_at_time: IDL.Opt(IDL.Nat64),
      fee: IDL.Opt(IDL.Nat), expected_allowance: IDL.Opt(IDL.Nat), expires_at: IDL.Opt(IDL.Nat64),
    })),
    timestamp: IDL.Nat64,
  });
  ...
  const GetAccountTransactionsResult = IDL.Variant({
    Ok: IDL.Record({ transactions: IDL.Vec(TransactionWithId), oldest_tx_id: IDL.Opt(IDL.Nat), balance: IDL.Nat }),
...
const CKETH_MINTER_CANISTER_ID = import.meta.env.VITE_CKETH_MINTER_CANISTER_ID || 'sv3dd-oaaaa-aaaar-qacoa-cai';
